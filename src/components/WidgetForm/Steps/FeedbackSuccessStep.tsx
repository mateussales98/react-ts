  ...
  return (
    <>
      ...
      <div className=" flex flex-col items-center py-10 w-[304px]">
        ...
        <span className=" text-lx mt-2">Agradecemos o seu Feedback!</span>

        <button
          type="button"
          onClick={onFeedbackRestartRequested}
          className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 trasition-colors focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-offset-zinc-900 focus:ring-bg-brand-300 focus:ring-brand-500 disabled:opacity-50 disabled:hover:to-brand-500"
        >
          Quero enviar outro
        </button>
